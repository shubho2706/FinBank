/*
 * Created by JFormDesigner on Sun May 12 01:57:34 IST 2019
 */
...
public class CreateAccount extends JFrame {
    ...
    private void initComponents() {
        ...
        savingsAction = new JButton();
        fixedAccount = new JButton();
        label4 = new JLabel();
        label6 = new JLabel();
        ...
        //======== background ========
        {
            ...
            //======== contentPanel ========
            {
                ...
                //---- savingsAction ----
                savingsAction.setIcon(new ImageIcon(getClass().getResource("/resource/savingsAccount.png")));
                savingsAction.addMouseListener(new MouseAdapter() {
                    @Override
                    public void mousePressed(MouseEvent e) {
                        savingsActionMousePressed(e);
                    }
                });

                //---- fixedAccount ----
                fixedAccount.setIcon(new ImageIcon(getClass().getResource("/resource/fixedDeposit.png")));
                fixedAccount.addMouseListener(new MouseAdapter() {
                    @Override
                    public void mousePressed(MouseEvent e) {
                        fixedAccountMousePressed(e);
                    }
                });

                //---- label4 ----
                label4.setText("Savings Account");
                label4.setHorizontalAlignment(SwingConstants.CENTER);
                label4.setForeground(new Color(204, 0, 0));
                label4.setFont(new Font("Segoe UI", Font.BOLD, 18));

                //---- label6 ----
                label6.setText("Fixed Account");
                    ...
                    contentPanelLayout.createParallelGroup()
                        .addGroup(contentPanelLayout.createSequentialGroup()
                            ...
                            .addGroup(contentPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                .addComponent(label4, GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE)
                                .addComponent(savingsAction, GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE))
                            .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 85, Short.MAX_VALUE)
                            .addGroup(contentPanelLayout.createParallelGroup()
                                .addComponent(fixedAccount, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE)
                                .addComponent(label6, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE))
                            .addGap(45, 45, 45))
                );
                contentPanelLayout.setVerticalGroup(
                    contentPanelLayout.createParallelGroup()
                        .addGroup(contentPanelLayout.createSequentialGroup()
                            .addGap(63, 63, 63)
                            .addGroup(contentPanelLayout.createParallelGroup()
                                .addComponent(fixedAccount, GroupLayout.PREFERRED_SIZE, 196, GroupLayout.PREFERRED_SIZE)
                                .addComponent(savingsAction, GroupLayout.PREFERRED_SIZE, 196, GroupLayout.PREFERRED_SIZE))
                            .addGap(18, 18, 18)
                            .addGroup(contentPanelLayout.createParallelGroup()
    ...
    private JButton savingsAction;
    private JButton fixedAccount;
    ...
    public void init() {
        ...
        frame.setContentPane(new CreateAccount().background);
    ...
    private void savingsActionMousePressed(MouseEvent e) {
        Instances.savingsAccountForm.init();

    }

    private void fixedAccountMousePressed(MouseEvent e) {
